...
#include "E:\Projects\Opencv3_Demo\8_harrisDetector_interestPoints\harrisDetector.h"

int interestPoints_Test() {

	// Harris:

	// Read input image
	cv::Mat image= cv::imread("E:\\Projects\\Opencv3_Demo\\images\\church01.jpg",0);
	if (!image.data)
		return 0; 
   ...
   // threshold the corner strengths
	...
	// Read input image
	image= cv::imread("E:\\Projects\\Opencv3_Demo\\images\\church01.jpg",0);
	// rotate the image (to produce a horizontal image)
	cv::transpose(image, image);
	cv::flip(image, image, 0);
	...
	image= cv::imread("E:\\Projects\\Opencv3_Demo\\images\\church03.jpg", cv::IMREAD_GRAYSCALE);
	// rotate the image (to produce a horizontal image)
	cv::transpose(image, image);
	cv::flip(image, image, 0);
	...
	// Read input image
	image= cv::imread("E:\\Projects\\Opencv3_Demo\\images\\church01.jpg", cv::IMREAD_GRAYSCALE);
	// rotate the image (to produce a horizontal image)
	cv::transpose(image, image);
	cv::flip(image, image, 0);
	...
	// Read input image
	image= cv::imread("E:\\Projects\\Opencv3_Demo\\images\\church01.jpg",CV_LOAD_IMAGE_GRAYSCALE);
	// rotate the image (to produce a horizontal image)
	cv::transpose(image, image);
	cv::flip(image, image, 0);
