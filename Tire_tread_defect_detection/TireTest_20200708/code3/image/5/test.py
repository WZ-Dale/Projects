...
# (for faster processing)
    imageA = cv2.imread('D:/Tire_Test/code3/image/5/frame1011.jpg')
    imageB = cv2.imread('D:/Tire_Test/code3/image/5/frame1111.jpg')
...
# show the images
    ...
    print('%.5f s' %(end-start))
    cv2.imwrite('D:/Tire_Test/code3/image/5/vis11.jpg', vis)
    cv2.imwrite('D:/Tire_Test/code3/image/5/result11.jpg', result)