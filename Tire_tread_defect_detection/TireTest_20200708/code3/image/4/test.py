...
# (for faster processing)
    imageA = cv2.imread('D:/Tire_Test/code3/image/4/frame101.jpg')
    imageB = cv2.imread('D:/Tire_Test/code3/image/4/frame111.jpg')
...
# show the images
    ...
    print('%.5f s' %(end-start))
    cv2.imwrite('D:/Tire_Test/code3/image/4/vis1.jpg', vis)
    cv2.imwrite('D:/Tire_Test/code3/image/4/result.jpg', result)