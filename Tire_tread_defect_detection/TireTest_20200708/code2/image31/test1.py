...
# img_left = cv2.imread('1.jpg', 1)
# img_right = cv2.imread('2.jpg', 1)
...
# 读取图片
img_left = cv2.imread('D:/Tire_Test/code2/image31/11.png', 1)
img_right = cv2.imread('D:/Tire_Test/code2/image31/21.png', 1)
