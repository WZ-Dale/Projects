...
# image = "D:\\Tire_Test\\image4\\21.jpg"
# gray = "D:\\Tire_Test\\image4\\p1.jpg"
path = "D:\\Tire_Test\\image7\\4\\"
image = path + "3.jpg"
gray = path + "zuidashang.jpg"
pixelsPerMetric = 4
# min = 100
# min = 200
# min = 200
...
# if the contour is not sufficiently large, ignore it（如果轮廓不够大，忽略它）
    ...
    for (x, y) in box:
        ...
        (int(tltrX - 15), int(tltrY - 10)), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)      # 0.65
